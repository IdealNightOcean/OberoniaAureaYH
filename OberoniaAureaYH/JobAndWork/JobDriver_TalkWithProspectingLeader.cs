...
public class JobDriver_TalkWithProspectingLeader : JobDriver_TalkWithAtOnce
{
    ...
    private static void AcceptResult(Pawn leader)
    {
        ...
        else
        {
            ...
            {
                talkILordJob.DisableTalk(dismiss: false);
            }
            lord.RemoveAllPawns();
        }
        ...
        if (!OAFrame_QuestUtility.TryGenerateQuestAndMakeAvailable(out Quest quest, OARK_QuestScriptDefOf.OARK_ProspectingTeam, slate, forced: true))
        {

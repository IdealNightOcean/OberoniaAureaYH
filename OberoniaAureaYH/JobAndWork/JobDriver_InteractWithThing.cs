...
public abstract class JobDriver_InteractWithThing : JobDriver
{
    ...
    protected override IEnumerable<Toil> MakeNewToils()
    {
        ...
        {
            JobFinishResult(pawn);
        });
    }

    protected abstract void JobFinishResult(Pawn pawn);

    protected virtual void AdjuestMainToil(ref Toil toil) { }

    protected virtual float GetTotalWorkAmount(float baseWorkAmount) { return baseWorkAmount; }

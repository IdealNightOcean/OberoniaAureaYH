...
public class SymbolResolver_ResearcherCamp : SymbolResolver_WorkSite
{
    ...
    public override void Resolve(ResolveParams rp)
    {
        ...
        rp.settlementLord = rp.singlePawnLord ?? LordMaker.MakeNewLord(faction, new LordJob_DefendBase(faction, rp.rect.CenterCell, 25000, rp.attackWhenPlayerBecameEnemy ?? false), map);

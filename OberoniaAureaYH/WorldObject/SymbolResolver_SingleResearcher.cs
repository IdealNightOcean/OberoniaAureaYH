...
public class SymbolResolver_SingleResearcher : SymbolResolver
{
    ...
    public override void Resolve(ResolveParams rp)
    {
        ...
        if (rp.singlePawnToSpawn is null)
        {
            ...
            {
                PawnKindDef pawnKindDef = rp.singlePawnKindDef ?? DefDatabase<PawnKindDef>.AllDefsListForReading.Where(x => x.defaultFactionType is null || !x.defaultFactionType.isPlayer).RandomElement();

...
public class ResearchSummit_AssistWork : WorldObject_InteractiveBase
{
    ...
    public void StartWork(Caravan caravan)
    {
        ...
        FixedCaravan_ResearchSummitAssistWork fixedCaravan = (FixedCaravan_ResearchSummitAssistWork)OAFrame_FixedCaravanUtility.CreateFixedCaravan(caravan, OARatkin_WorldObjectDefOf.OA_FixedCaravan_ResearchSummitAssistWork, FixedCaravan_ResearchSummitAssistWork.CheckInterval);
